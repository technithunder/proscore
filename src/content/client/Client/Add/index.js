...
import { addClient, clientName, getAllClientType } from 'src/api/client/client';
...
const AddClient = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{'Add Partner - Partner'}</title>
      </Helmet>
      <PageTitleWrapper>
        <PageHeader
          Component={Box}
          heading={t('Add Partner')}
          description={t('Fill in the below to add partner')}
          pathname={'/partner'}
      ...
      <Formik
        ...
        onSubmit={async (
          ...
          let obj = {
            logo: _values.logoUrl,
            logoMediaModel: {
              base64String: _values?.logoUrl ?? '',
              fileName: _values.logo?.name ?? ''
            },
                ...
                <Grid container spacing={2} mb={4}>
                  ...
                  <Grid item xs={12} md={6}>
                    <TextField
                      ...
                      error={Boolean(touched.mailingCity && errors.mailingCity)}
                    />
                  </Grid>
